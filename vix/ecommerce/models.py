...
class PurchaseOrder(models.Model):
   ...
   #purchased_products = models.ManyToManyField(Purchase, through='Purchase')
...
class Purchase(models.Model):
    purchase_order = models.ForeignKey(PurchaseOrder, on_delete=models.CASCADE, related_name='purchased_products')
